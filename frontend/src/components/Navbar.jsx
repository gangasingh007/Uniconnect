...
const Navbar = () => {
    ...
    return (
        <nav className="w-full px-6  py-4 flex items-center justify-between bg-gradient-to-r from-[#141423] to-[#1a1a2e] border-b border-[#2a2a40] shadow-lg backdrop-blur-sm sm:">
            {/* Left: Logo */}
