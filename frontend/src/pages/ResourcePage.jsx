                 ...
                 <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                         {resource.type === 'Document' && (
                             <motion.button whileHover={{scale: 1.1}} whileTap={{scale: 0.9}} onClick={(e) => { e.stopPropagation(); onSummarize(resource._id); }} className="p-2 bg-purple-500/20 hover:bg-purple-500/40 text-purple-300 rounded-full" aria-label="Summarize">
                                 <Sparkles size={16} />
                             </motion.button>
                         )}
                    </div>
